...
const recruitStepTexts = [
    {
        category: "select1",
        title: "라이나생명 직원 인재채용에 지원하고 싶습니다. 어떻게 해야하나요?",
        desc: "상단 ‘채용 절차’에서 365일 24시간 언제든지 지원 가능합니다. 서류작성 > 1차인터뷰 > 2차인터뷰 > 고용심사 및 레퍼런스 체크 > 처우협상 > 최종합격 순서로 진행됩니다. 경력 및 고용 형태에 따라 채용 절차가 추가되거나 생략될 수 있습니다. 인터뷰는 대면 또는 비대면으로 진행되며, 비대면 면접 진행 시 별도의 화상미팅 Tool에 접속하거나 모바일 앱설치가 필요합니다."
    },
];
...
function openTmr(){
    window.open('https://www.lina.co.kr/tmr/main/main.htm', 'TMR | 라이나생명', 'width=992px,height=926px,scrollbars=yes');
}